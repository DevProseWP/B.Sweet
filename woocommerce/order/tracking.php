<h2 style="text-align: center;">Hello <?php printf( $order->billing_first_name . ' ' . $order->billing_last_name ); ?> here is your order</h2>
...
<div style="text-align: center;">
	<b>If there is a problem with your order please contact us as soon as possible:</b>
	<br><br>
